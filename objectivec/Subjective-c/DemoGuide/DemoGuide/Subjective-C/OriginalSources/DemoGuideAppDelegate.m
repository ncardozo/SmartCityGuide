...
- (void)copyDatabaseIfNeeded:(BOOL)needUpdate {
    ...
    /*
     NSString *dbPathLocal = @"/Users/guillaumekaisin/Dropbox/Mémoire/donnees_app/miniDB.sqlite";
     NSDictionary * localProp = [[NSFileManager defaultManager]
     attributesOfItemAtPath:dbPath
     error:&error];
     NSDate * remoteDate = [remote_prop objectForKey:NSFileModificationDate];
     NSDate * localDate = [local_prop objectForKey:NSFileModificationDate];

...
@implementation SmartCityGuideAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [CacheManager setStrategy:[[NSClassFromString([NSString stringWithFormat:@"CacheManager%@", @"EN"])alloc] init]];

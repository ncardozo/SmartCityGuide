...
(defun base-print-strategy ((poi @poi))
	...
	(defvar *fun-desc* (format nil "~ddescription-strategy" *lang-context*))
	(defvar *fun-address* (format nil "~daddress-strategy" *lang-context*))
	(defvar *fun-image* (format nil "~dimage-strategy" *time-context*))
	(defvar *fun-kidlang-desc* (format nil "~ddescription-strategy" *kidlang-context*))
	(format t "POI Information~%")
	(format t "Id: ~d~%" (id poi))
	(format t "Name: ~d~%" (funcall (intern *fun-name* poi)))
	(if (eq *kid-context* "kid-")	(format t "Description: ~d~%" (funcall (intern *fun-kidlang-desc* poi))) 
									(format t "Description: ~d~%" (funcall (intern *fun-desc* poi))))
	(format t "Address: ~d~%" (funcall (intern *fun-addess* poi)))
	(format t "Image: ~D~%" (funcall (intern *fun-image* poi)))
